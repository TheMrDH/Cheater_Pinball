    ...
    public class MyCharacterController : MonoBehaviour, ICharacterController
    {
        ...
        public void UpdateVelocity(ref Vector3 currentVelocity, float deltaTime)
        {
            ...
            if (Input.GetMouseButton(0))
            {
                ...
                _mousePos = (cam.ScreenToWorldPoint(new Vector3(mPos.x, mPos.y, Vector3.Distance(cam.transform.position, transform.position)) - transform.position));
            ...
            else
            {
                ...
                if (_mousePos.magnitude > 0 && !Input.GetMouseButton(0))
                {
                    currentVelocity -= _mousePos.magnitude * _mousePos;
                }
